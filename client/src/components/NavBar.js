    ...
    return (
      <div id="NavBar" className="row m-0 pt-2 mb-lg-n5">
        <div className="col-2 mx-auto">
          <a className="nav-link active link-primary" aria-current="page" href="/"><img id="navLogo" src={LogoSVG} className="navLogo float-left" alt="Piboy Technical Solutions Ltd."/></a>
        </div>
