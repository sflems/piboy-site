    ...
    <motion.main layoutId="privacy" className="m-0 p-0 text-center">
      ...
      >
        ...
        >
          ...
          <p>
            Piboy Technical Solutions Ltd. has built the{" "}
            <a className="link-success" href="/">
              https://piboy.ca
            </a>{" "}
            site as a commercial app. This service is provided by Piboy
            Technical Solutions Ltd. and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Piboy Site unless
          ...
          <p>
            ...
            including but not limited to Name, email, telephone, company, text
            communications.. The information that we request will be retained by
          ...
          <h4>Contact Forms</h4>
          <p>
            The contact forms on this website collect and store the data you
            submit. You can contact us to request that your data be removed at
            any time. This data is only used as a means of responding to your
            inquiries. Submitting a Contact Form request on our website means
            that you consent to our collection and storage of the data
            submitted. This site is protected by reCAPTCHA and the Google{" "}
            <a
              className="link-success"
              href="https://policies.google.com/privacy"
            >
          ...
          <p>
            ...
            memory. You may also manually <a className="link-success" href="https://tools.google.com/dlpage/gaoptout/">opt out of Google Analytics tracking.</a>
          </p>
          ...
          <p>
            ...
            page.
            <br />
            <small>{" "}* This policy is effective as of 2021-11-21.</small>
          </p>
          <h4>Contact Us</h4>
          <p>
